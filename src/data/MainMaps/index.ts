 ...
 * europe.json - `viewBox` plus a `territories` array of {id, name, path, neighbors, centroid})
 * into this folder and add one entry here pointing at it. Nothing outside this folder needs to
...
export const MAIN_MAPS: readonly MainMapEntry[] = [
  { id: 'europe', name: 'Europa', data: europe as TerritoryData },
  { id: 'asia', name: 'Asien', data: asia as TerritoryData },
];
